...
export const AudioPlayerElement = forwardRef<HTMLAudioElement, AudioPlayerElementProps>(
  ({ ...props }, ref) => (
    <audio
      ref={ref}
...
export const AudioPlayerPlayButton = ({ className, ...props }: AudioPlayerPlayButtonProps) => (
  <Button size="icon" variant="outline" className={cn("size-8", className)} nativeButton={false} render={<MediaPlayButton data-slot="audio-player-play-button" {...props} />}></Button>
)
...
export const AudioPlayerSeekBackwardButton = ({
  ...
  <Button size="icon" variant="outline" className={cn("size-8", className)} nativeButton={false} render={<MediaSeekBackwardButton data-slot="audio-player-seek-backward-button" seekOffset={seekOffset} {...props} />}></Button>
)
...
export const AudioPlayerSeekForwardButton = ({
  ...
  <Button size="icon" variant="outline" className={cn("size-8", className)} nativeButton={false} render={<MediaSeekForwardButton data-slot="audio-player-seek-forward-button" seekOffset={seekOffset} {...props} />}></Button>
)
...
export const AudioPlayerMuteButton = ({ className, ...props }: AudioPlayerMuteButtonProps) => (
  <Button size="icon" variant="ghost" className={cn("size-8", className)} nativeButton={false} render={<MediaMuteButton data-slot="audio-player-mute-button" {...props} />}></Button>
)
