  ...
  return (
    <header className="h-13 !border-b px-3 w-full flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="group relative size-9 cursor-pointer shrink-0 outline-none">
            <svg
              className="absolute inset-0 -rotate-90"
              viewBox="0 0 36 36"
              fill="none"
            >
              <circle cx="18" cy="18" r="16" strokeWidth="2" className="stroke-zinc-200" />
              <circle
            ...
            <Avatar className="absolute inset-[3px] size-auto after:hidden m-0.5 group-hover:opacity-0 transition-opacity">
              <AvatarImage
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
              <span className="font-montserrat text-zinc-900 text-[9px] font-semibold leading-none">
                {Math.round(progress * 100)}%
              </span>
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" sideOffset={14} className="w-56 p-0.5 bg-gray-50 overflow-hidden">
            <DropdownMenuGroup>
              <div className="bg-background border border-border rounded-lg p-3 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative size-5 shrink-0">
                      <svg className="absolute inset-0 -rotate-90" viewBox="0 0 36 36" fill="none">
                        <circle cx="18" cy="18" r="16" strokeWidth="3" className="stroke-zinc-300" />
                        <circle
                    ...
                    <span className="font-montserrat text-xs font-semibold text-zinc-900">Balance</span>
                  </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-montserrat text-xs font-medium text-zinc-900">10,000 credits</span>
                  </div>
                  {/* Row 3: Remaining */}
                  <div className="flex items-center justify-between">
                    <span className="font-montserrat text-xs text-muted-foreground">Remaining</span>
                    <span className="font-montserrat text-xs font-medium text-zinc-900">8,147</span>
                  </div>
            ...
            <DropdownMenuGroup className="bg-background overflow-hidden border-y mt-1 px-0.5 -mx-0.5 py-1">
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuSubContent className="w-48" sideOffset={8}>
                  <DropdownMenuItem className="px-2 !py-1.5 rounded-md font-medium text-sm">System</DropdownMenuItem>
                  <DropdownMenuItem className="px-2 !py-1.5 rounded-md font-medium text-sm">Light</DropdownMenuItem>
                  <DropdownMenuItem className="px-2 !py-1.5 rounded-md font-medium text-sm">Dark</DropdownMenuItem>
                </DropdownMenuSubContent>
              </DropdownMenuSub>
            </DropdownMenuGroup>
